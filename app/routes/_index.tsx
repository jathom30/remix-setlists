              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <P>
                    ...
                    icon. Apart from songs and setlists unique to the band,
                    bands can create custom "feels" or genre tags to add to
                    songs.
                  </P>
                  <P>
                    Admin members in bands can choose to add or remove members
                    to their band.
                  </P>
                  <Separator />
                  <H4>Band members</H4>
                  <P>
                    Bands can assign permissions to its members individually.
                  </P>
                  <P>
                    <strong className="text-primary">Admin</strong>: Admins have
                    full read/write/delete permissions for their band as well as
                    its setlists, songs, and feels. Admins are capable of
                    removing and inviting members (as well as deleting the band,
                    if they so choose).
                  </P>
                  <P>
                    <strong className="text-primary">Member</strong>: Members
                    have read only permissions for band specific settings.
                    However, they have full read/write/delete permissions for
                    setlists, songs, and feels.
                  </P>
                  <P>
                    <strong className="text-primary">Sub</strong>: Subs have
                    read only permissions throughout the app. This is ideal for
                    new members who need access to the band's setlists and song
          ...
          <AnimateInView>
            <div className="flex gap-4 items-center flex-col md:flex-row">
              <Card>
                ...
                <CardContent className="space-y-2">
                  <P>
                    Using our drag and drop system, editing setlists is a
                    breeze!
                  </P>
                  <Separator />
                  <P>
                  ...
                  <P>
                    ...
                    No problem! Setlists can be shared publically at any time.
                    Now the sound guy at your show knows where you are in the
                    set and can plan for that upcoming ballad or screamer.
                  </P>
                </CardContent>
              </Card>
              <img
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <P>
                    ...
                    doc? No problem, we allow you to create a link that will
                    send you right to it.
                  </P>
                  <Separator />
                  <P>
                    Each song can be tagged with any number of "feels". These
                    help you organize your songs when creating setlists or just
                    to keep track of how many swing tunes your band has been
                    learning.
                  </P>
                </CardContent>
              </Card>
          ...
          <AnimateInView>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  <span className="text-primary">Not a problem!</span> Setlists
          ...
          <AnimateInView>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  <span className="text-primary">Absolutely nothing!</span> This
                  is the beta release of Setlists. At this time access to the
                  app is entirely free. However, be aware that you may find some
                  bugs. If you do, feel free to report them to us at{" "}
                  <a
