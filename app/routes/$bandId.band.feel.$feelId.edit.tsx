      ...
      <FlexList pad={4}>
        ...
        <div className="flex gap-4">
          ...
          <div className="w-full h-30 flex flex-col gap-1">
            <div
              className="font-bold h-full flex items-center justify-center rounded-t-lg"
              style={{
            ...
            <div
              className="font-bold h-full flex items-center justify-center rounded-b-lg"
