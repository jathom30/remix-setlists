    ...
    <FlexList pad={4}>
      <FlexList gap={0}>
        ...
        <span className="text-text-subdued text-sm">
          Invite new members with the band code below.
        </span>
      </FlexList>
      ...
      <FlexList gap={0}>
        ...
        <CopyClick
          textToCopy={band.code}
          copyMessage={band.code}
          successMessage="Band code copied!"
        />
      </FlexList>
      ...
      <FlexList gap={2}>
        ...
        <Button onClick={() => setShowQr(!showQr)} isOutline icon={faQrcode}>
      ...
      <div>
        ...
        <FlexList>
          <p className="text-sm">
            All invited members will automatically be added as <b>SUB</b>s. They
            will be able to see your setlists and songs, but will not be able to
            make any changes.
          </p>
          <p className="text-sm">
            If you wish to upgrade their role, you can do so by clicking on
            their name in the members list after they join this band.
          </p>
        </FlexList>
      </div>
    </FlexList>
