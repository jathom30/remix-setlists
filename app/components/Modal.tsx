  ...
  if (!isPortal) {
    return (
      <AnimatePresence mode="wait">
        {open ? (
          <div key="drawer" className="fixed inset-0 z-10">
            <motion.div
              role="presentation"
              onTap={onClose}
              initial={{
            ...
            <motion.div
              ...
              className="absolute top-8 max-h-[calc(100vh - 4rem)] inset-x-4 bg-base-100 rounded overflow-auto max-w-2xl m-auto"
